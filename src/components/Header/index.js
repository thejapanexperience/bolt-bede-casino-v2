...
export default HeaderHO(
  ({ className, siteTitle, openLoginModal, openRegistrationModal }) => (
    <Header siteTitle={siteTitle}>
      ...
      <div>
        <ButtonPrimary title="Login" onClick={openLoginModal} />
        <ButtonPrimary title="Register" onClick={openRegistrationModal} />>
      </div>
    </Header>
  )
)
