...
const UnwrappedHeader = (props: Props) => {
  const {
    className,
    siteTitle,
    openLoginModal,
  ...
  return (
    <Header siteTitle={siteTitle}>
      ...
      <Buttons>
        <Button onClick={openLoginModal} primary title={lang.buttonLogin} />
        <Button onClick={openRegistrationModal} primary title={lang.buttonRegister} />
        <LangButton onClick={() => setLanguage('en_GB')} title={lang.en_GB} />
        <LangButton onClick={() => setLanguage('en_US')} title={lang.en_US} />
      </Buttons>
    </Header>
  );
};

export default HeaderHO(UnwrappedHeader);
